...
class tetranyte(pluginTemplate):
    __model__ = "tetranyte"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","tetranyte")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for tetranyte start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs

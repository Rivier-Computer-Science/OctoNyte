...
#endif
            VL_FATAL_MT("/workspaces/Preetham-OctoNyte/RTL/Chisel/generators/generated/verilog_sv2v/ALU32.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VALU32___024root___ctor_var_reset(VALU32___024root* vlSelf) {
    ...
    vlSelf->io_opcode = VL_RAND_RESET_I(6);
}
